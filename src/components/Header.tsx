            ...
            <motion.div
                ...
                <div className="grid grid-cols-2">
                    ...
                    <nav className="items-center justify-end space-x-2 sm:flex hidden">
                        ...
                        <Link href={`https://github.com/${Contents.GithubName ? Contents.GithubName : 'aydocs'}`} className="group bg-foreground/5 rounded-3xl" aria-label="TaxPal on GitHub" target='_blank'>
                            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" className="text-gray-500 duration-200 hover:text-gray-300 bg-gray-500 hover:bg-gray-600/10 bg-opacity-5 rounded-full p-2" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Link href={`https://www.instagram.com/${Contents.Instagram ? Contents.Instagram : 'aydocs.js'}`} className="group bg-foreground/5 rounded-3xl" aria-label="TaxPal on Instagram" target='_blank'>
                        ...
                        <Link href={`https://twitter.com/${Contents.Twitter ? Contents.Twitter : 'aydocs.js'}`} className="group bg-foreground/5 rounded-3xl" aria-label="TaxPal on Twitter/X" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 1200 1227" className="text-gray-500 duration-200 hover:text-gray-300 bg-gray-500 hover:bg-gray-600/10 bg-opacity-5 rounded-full p-2" width="2em" height="2em">
                                <path d="M714.6 553.4L1170.3 0H1064.1L667.5 479.7L355.1 0H0L476.2 706.5L0 1227H106.2L529.6 714.2L864.9 1227H1220L714.6 553.4ZM580.5 644.5L540.9 588.2L165.1 89.8H301.9L620.3 558.6L660 614.8L1052.3 1182.2H915.4L580.5 644.5Z" />
                            </svg>
                        </Link>
